...
module.exports = {
  data: new SlashCommandBuilder().setName('hymne1').setDescription("Lancer l'hymne 1"),
  async execute(interaction, ctx) {
    ...
    try {
      ...
      const result = await ctx.player.search(HYMNE_1, { requestedBy: interaction.user, searchEngine: QueryType.AUTO });
